...
relies on its semantic form, table, button, and typography defaults. A small inline
stylesheet is limited to the responsive application grid, header contrast, numeric
alignment, and status-message states.
