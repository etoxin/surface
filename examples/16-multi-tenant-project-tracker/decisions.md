...
deno run --allow-net --allow-read \
  examples/16-multi-tenant-project-tracker/app/server.ts
```
...
deno test --allow-read \
  examples/16-multi-tenant-project-tracker/app/domain_test.ts \
  examples/16-multi-tenant-project-tracker/app/server_test.ts
```
